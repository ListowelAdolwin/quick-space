								...
								<div>
									...
									<div className="w-full flex items-center mt-6 space-x-2 sm:space-x-4 overflow-hidden text-xs sm:text-sm">
										...
										<button
											...
											className={`relative basis-1/2 border text-blue-600 hover:bg-blue-600 hover:text-white border-blue-600 font-bold py-2 px-1 sm:px-2 rounded transition-colors duration-300 flex items-center justify-center ${
												likeLoading
													? "cursor-not-allowed"
													: ""
											}`}
